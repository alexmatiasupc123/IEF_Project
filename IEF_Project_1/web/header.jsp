<header>
			...
			<div class="custom-search pull-left hidden-xs hidden-sm">
				<input type="text" class="search-query" placeholder="Busca aquí">
				...
				<ul id="mini-nav" class="clearfix">
					...
					<li class="list-box dropdown hidden-xs">
						...
						<ul class="blog-gallery dropdown-menu fadeInDown animated clearfix recent-tweets">
							...
							<li>
								<img src="assets/img/user4.jpg" alt="User">
							</li>
							<li>
								<img src="assets/img/user5.jpg" alt="User">
							</li>
							<li>
								<img src="assets/img/user6.jpg" alt="User">
							</li>
							<li>
								<img src="assets/img/user7.jpg" alt="User">
							</li>
							<li>
								<img src="assets/img/user8.jpg" alt="User">
							</li>
							<li>
								<img src="assets/img/user9.jpg" alt="User">
							</li>
							<li>
								<img src="assets/img/user3.jpg" alt="User">
							</li>
