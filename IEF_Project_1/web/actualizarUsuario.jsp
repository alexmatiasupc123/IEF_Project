        ...
        <!-- Bootstrap CSS -->
         ...
         <%                
               ...
               if(user!=null)
               {
                    ...
                    fechanacimiento=df.format(user.getFechaNacimiento());
               }
								...
								<div class="blog">
									...
									<div class="blog-body">
										<form class="form-horizontal" role="form" method="post" action="ServletUsuario" onsubmit="return validarFechaMenorActual(document.getElementById('inputFecha').value);">
										    ...
										    <div class="col-sm-4">
                                                                                                                                                                    <input style="background-color: lavender;" type="text" class="form-control" name="usuario" id="inputUsuario" value="<%=user.getCodigo()%>" readonly >
                                                                                                                                                                    <input type="hidden" name="accion" value="update" >
                                                                                                                                                                    <input type="hidden" name="id" value="<%= user.getUsuarioId() %>" >
										    </div>
										  </div>
